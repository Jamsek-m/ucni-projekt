...
import EtcdServiceConfiguration from 'modules/discovery/etcd/EtcdServiceConfiguration';
import EtcdRegistrator from 'modules/discovery/etcd/EtcdRegistrator';
import CommonUtil from 'modules/discovery/common/CommonUtil';

import { getEtcdDir, getLastKeyLayer, getServiceKeyInstances } from 'modules/discovery/etcd/EtcdUtils';
...
class EtcdDiscoveryUtil {
  ...
  async register(serviceName, version, environment, ttl, pingInterval, singleton) {
    ...
    let containerUrl = await ConfigurationUtil.get('kumuluzee.server.container-url') || null;
