// @flow
import FileConfigurationSource from 'modules/configuration/sources/FileConfigurationSource';
import EnvironmentConfigurationSource from 'modules/configuration/sources/EnvironmentConfigurationSource';
import ConsulConfigurationSource from 'modules/configuration/sources/ConsulConfigurationSource';
import Etcd2ConfigurationSource from 'modules/configuration/sources/Etcd2ConfigurationSource';

import ConfigurationDispatcher from 'modules/configuration/utils/ConfigurationDispatcher';
