...
var ConfigBundle = function () {
  ...
  _createClass(ConfigBundle, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                _context.next = 8;
                return _ConfigurationUtil.ConfigurationUtil.initialize(extension, this._configuration);
                        ...
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            case 0:
                              ...
                              _context2.next = 9;
                              return _ConfigurationUtil.ConfigurationUtil.getListSize(keyPath);
                            ...
                            case 9:
                              ...
                              for (i = 0; i < size; i++) {
                                promise = _ConfigurationUtil.ConfigurationUtil.get(keyPath + '[' + i + ']');
                            ...
                            case 33:
                              _context2.next = 35;
                              return _ConfigurationUtil.ConfigurationUtil.get(keyPath);
    ...
    value: function deployWatcher(key) {
      ...
      _ConfigurationUtil.ConfigurationUtil.subscribe(key, function () {
          ...
          return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  if (key === thisKey) {
                    splittedKey = _this2.getPath(key, _ConfigurationUtil.ConfigurationUtil.configuration);

                    splittedKey = splittedKey.split('.');

                    _type = _this2.determineType(splittedKey.slice(1), _ConfigurationUtil.ConfigurationUtil.configuration);
...
exports.ConfigurationUtil = _ConfigurationUtil.ConfigurationUtil;
